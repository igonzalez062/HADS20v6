...
<body>
    ...
    <div>
        ...
        <ajaxToolkit:PasswordStrength ID="TextBoxContraseña_PasswordStrength" runat="server" TargetControlID="TextBoxContraseña" DisplayPosition="RightSide" PreferredPasswordLength="10" PrefixText="Fuerza de la contraseña:" TextCssClass="TextIndicator_TextBox1"
            MinimumNumericCharacters="1" MinimumSymbolCharacters="1" RequiresUpperAndLowerCaseCharacters="True"
            TextStrengthDescriptions="Muy Debil;Debil;Normal;Fuerte;Excelente" 
